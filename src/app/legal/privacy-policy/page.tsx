          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <div className="bg-surface rounded-xl p-6 mb-8 shadow-sm">
                <h2 className="text-2xl font-bold text-burgundy mb-4">Information We Collect</h2>
              ...
              <div className="bg-surface rounded-xl p-6 mb-8 shadow-sm">
                <h2 className="text-2xl font-bold text-burgundy mb-4">How We Use Your Information</h2>
              ...
              <div className="bg-surface rounded-xl p-6 mb-8 shadow-sm">
                <h2 className="text-2xl font-bold text-burgundy mb-4">Premium User Data</h2>
                <p className="mb-4">For users with premium subscriptions, we collect and process additional information:</p>
                <ul className="list-disc pl-6 text-darkSlate">
              ...
              <div className="bg-surface rounded-xl p-6 mb-8 shadow-sm">
                <h2 className="text-2xl font-bold text-burgundy mb-4">Sharing Your Information</h2>
              ...
              <div className="bg-surface rounded-xl p-6 mb-8 shadow-sm">
                <h2 className="text-2xl font-bold text-burgundy mb-4">Your Rights and Choices</h2>
                ...
                <p className="mt-4">To exercise these rights, please contact us at privacy@patropatri.com.</p>
              </div>

              <div className="bg-surface rounded-xl p-6 mb-8 shadow-sm">
                <h2 className="text-2xl font-bold text-burgundy mb-4">Data Security</h2>
                ...
                <p className="mt-4">However, no method of transmission over the Internet or electronic storage is 100% secure, so we cannot guarantee absolute security.</p>
              </div>

              <div className="bg-surface rounded-xl p-6 mb-8 shadow-sm">
                <h2 className="text-2xl font-bold text-burgundy mb-4">Changes to This Privacy Policy</h2>
                <p>We may update this Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page and updating the "Last updated" date. You are advised to review this Privacy Policy periodically for any changes.</p>
              </div>

              <div className="bg-surface rounded-xl p-6 shadow-sm">
                <h2 className="text-2xl font-bold text-burgundy mb-4">Contact Us</h2>
