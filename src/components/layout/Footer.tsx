        ...
        >
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/careers" className="text-gray-300 hover:text-gold transition-colors duration-300 flex items-center"><span className="mr-2">→</span> Careers</Link></li>
