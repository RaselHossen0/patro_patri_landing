...
const FeaturesSection = ({ isVisible = false, title, subtitle, features: customFeatures, showPremiumBadge }: FeaturesSectionProps) => {
  ...
  return (
    <section ref={featuresRef} id="features" className="py-16 md:py-24 bg-appBackground">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-3 text-darkSlate">{feature.title}</h3>
        ...
        >
          <a href="#how-it-works" className="inline-flex items-center text-burgundy hover:text-burgundy-dark font-medium">
